...
const Slideshow = ({items, startIndex}) => {
    ...
    return (
            <div className={"slide-show"}>
                <div className={"slide-show__container"} style={carouselStyle}>
                    {
                ...
                {items.length > 1 && (
                    <>
                        <div className="slide-show__commands">
                            <button onClick={handlePrevClick} className={"slide-show__previous"}>
                            ...
                            <button onClick={handleNextClick} className={"slide-show__next"}>
                                <svg viewBox="0 0 96 96" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div className="slide-show__count">
